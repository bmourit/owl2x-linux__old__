/*
 * linux/drivers/video/actx/actfb_main.c
 *
 * Copyright (C) 2011-2013 Actions Semiconductor Co., LTD
 * Author: wanghui <www.actions-semi.com>
 *
...
#include "actfb_main.h"
#include "../act_fb/wvga_logo.h"
#include "../act_de/display.h"
#include "../act_de/de_core.h"

#define MODULE_NAME    "actfb"

#define ACTFB_PLANE_XRES_MIN		8
#define ACTFB_PLANE_YRES_MIN		8
