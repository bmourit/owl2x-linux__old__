 ...
 * Boyd Mouritsen <bnmguy@gmail.com>
 * 
...
#ifndef __ASM_ATM702X_DMA_H
#define __ASM_ATM702X_DMA_H
...
/**
 * request_atm702x_dma() - request the dma channel
 ...
 *
 * One can provide multiple line descriptions for arguments.
 *
 * function request_atm702x_dma() is used to request the dma channel.
 *
