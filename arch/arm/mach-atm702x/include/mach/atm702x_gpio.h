/*
 * arch/arm/mach-atm702x/include/mach/atm702x_gpio.h
 *
...
#ifndef __ATM702X_GPIO_H__
#define __ATM702X_GPIO_H__
...
enum gpio_group {
    ...
    GPIO_GROUP_D,
    GPIO_GROUP_E,
    GPIO_GROUP_5302,    // specially for atm702x
};
