...
/******************************************************************************/
#ifndef __ATM702X_LCD_H__
#define __ATM702X_LCD_H__
...
/******************************************************************************/
/*LCD_CTRL0*/
#define LCD_CTRL0_SEL_MASK							(0x1 << 31)
#define LCD_CTRL0_SEL_RGBI							(0x0 << 31)
#define LCD_CTRL0_SEL_CPUI							(0x1 << 31)

#define LCD_CTRL0_SELF_RST_EN						(0x1 << 31)
/*bit 19-29 Reserved*/
#define LCD_CTRL0_IF_MASK								(0x7 << 16)
#define LCD_CTRL0_IF_24P								(0x0 << 16)
#define LCD_CTRL0_IF_18P								(0x1 << 16)
#define LCD_CTRL0_IF_16P								(0x2 << 16)
#define LCD_CTRL0_IF_8P               	(0x3 << 16)							
#define LCD_CTRL0_IF_24S              	(0x4 << 16)							
#define LCD_CTRL0_IF_18S              	(0x5 << 16)							
                                      							
#define LCD_CTRL0_CC_ODD_MASK          	(0x7 << 13)							
#define LCD_CTRL0_CC_ODD_RGB           	(0x0 << 13)							
#define LCD_CTRL0_CC_ODD_RBG           	(0x1 << 13)							
#define LCD_CTRL0_CC_ODD_GRB           	(0x2 << 13)							
#define LCD_CTRL0_CC_ODD_GBR           	(0x3 << 13)							
#define LCD_CTRL0_CC_ODD_BRG           	(0x4 << 13)							
#define LCD_CTRL0_CC_ODD_BGR           	(0x5 << 13)							

#define LCD_CTRL0_CC_EVEN_MASK          (0x7 << 10)
#define LCD_CTRL0_CC_EVEN_RGB           (0x0 << 10)
#define LCD_CTRL0_CC_EVEN_RBG           (0x1 << 10)
#define LCD_CTRL0_CC_EVEN_GRB           (0x2 << 10)
#define LCD_CTRL0_CC_EVEN_GBR           (0x3 << 10)
#define LCD_CTRL0_CC_EVEN_BRG           (0x4 << 10)
#define LCD_CTRL0_CC_EVEN_BGR           (0x5 << 10)

#define LCD_CTRL0_PAD_MASK              (0x3 << 8)
#define LCD_CTRL0_PAD_NO                (0x0 << 8)
#define LCD_CTRL0_PAD_XAFTER            (0x1 << 8)
#define LCD_CTRL0_PAD_XBEFORE           (0x2 << 8)

#define LCD_CTRL0_VOM_MASK              (0x3 << 6)
#define LCD_CTRL0_VOM_DMA               (0x0 << 6)
#define LCD_CTRL0_VOM_DE                (0x1 << 6)
#define LCD_CTRL0_VOM_DEFCOLOR          (0x2 << 6)

/*bit 5 Reserved*/
#define LCD_CTRL0_FDE		               	(0x1 << 4)

#define LCD_CTRL0_ETH_MASK		          (0x3 << 2)
#define LCD_CTRL0_ETH_8_16		          (0x2 << 2)
#define LCD_CTRL0_ETH_12_16		          (0x3 << 2)

#define LCD_CTRL0_RB_SWAP_EN            (0x1 << 1)
#define LCD_CTRL0_EN                    (0x1 << 0)
...
#define LCD_STATUS_HBI                  (0x1 << 30)
#define LCD_STATUS_AVSI                 (0x1 << 29)
#define LCD_STATUS_UDF                  (0x1 << 28)
#define LCD_STATUS_UDFIE                (0x1 << 27)
#define LCD_STATUS_FEI                  (0x1 << 26)
#define LCD_STATUS_FEIE                 (0x1 << 25)
/*bit 22-24 Reserved*/
