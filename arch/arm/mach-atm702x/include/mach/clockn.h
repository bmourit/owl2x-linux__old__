 ...
 *
 */
#ifndef __ARM_GL5302_CLOCK_H__
#define __ARM_GL5302_CLOCK_H__
...
/**
 * Describes the frequency division ratio by the number of decimal places.
 * Using the formula (1/CLK_DIV_FACTOR).
 * For expmple:
 * CLK_DIV_FACTOR = 2 sets the coefficient increment to 0.5 (1/CLK_DIV_FACTOR).
 */
    ...
    /*for clock tree*/
        ...
        union {
                ...
                struct {
                        ...
                        unsigned long   min_rate;
                        u32             rate_step;
                        u32             lock_delay; /* pll stabilzation time */
                        unsigned long   fixed_rate; 
                        unsigned long   *freq_point_array;
                } pll;
...
//struct clk_hw *atm702x_clk_get_parent(struct clk_hw_atm702x *clk);
//void propagate_rate(struct clk_hw_atm702x *tclk);
//#else
...
#define CLK_NAME_SI_CLK             "si_clk"        //for newer
...
#define CLK_NAME_SENSOR_OUT_CLK     "sensor_out_clk"    //for newer
