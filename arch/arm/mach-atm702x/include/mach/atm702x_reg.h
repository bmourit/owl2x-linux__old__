/*
 * Register definitions for Actions ATM702X SoCs
 *
 * Copyright (C) 2013
 *
 * Spec Version_V2.02
...
#ifndef __ATM702X_REG_DEFINITION_H___
#define __ATM702X_REG_DEFINITION_H___
...
#define     CMU_CONTROL_REGISTER_BASE				0xb0150000
#define     CMU_DISPLAYPLL 							(CMU_CONTROL_REGISTER_BASE+0x0010)
#define     CMU_TVOUTPLL							(CMU_CONTROL_REGISTER_BASE+0x0018)
#define     CMU_SENSORCLK							(CMU_CONTROL_REGISTER_BASE+0x0020)
#define     CMU_BISPCLK								(CMU_CONTROL_REGISTER_BASE+0x0034)
#define     CMU_PWM0CLK								(CMU_CONTROL_REGISTER_BASE+0x0070)
#define     CMU_PWM1CLK								(CMU_CONTROL_REGISTER_BASE+0x0074)
#define     CMU_PWM2CLK								(CMU_CONTROL_REGISTER_BASE+0x0078)
#define     CMU_PWM3CLK								(CMU_CONTROL_REGISTER_BASE+0x007C)
#define     CMU_USBPLL								(CMU_CONTROL_REGISTER_BASE+0x0080)
#define     CMU_DEVCLKEN0							(CMU_CONTROL_REGISTER_BASE+0x00A0)
#define     CMU_DEVCLKEN1							(CMU_CONTROL_REGISTER_BASE+0x00A4)
#define     CMU_DEVRST0								(CMU_CONTROL_REGISTER_BASE+0x00A8)
#define     CMU_DEVRST1								(CMU_CONTROL_REGISTER_BASE+0x00AC)
#define     CMU_DEVPLLDEBUG							(CMU_CONTROL_REGISTER_BASE+0x00DC)
#define     CMU_TVOUTPLL0DEBUG						(CMU_CONTROL_REGISTER_BASE+0x00EC)
#define     CMU_TVOUTPLL1DEBUG						(CMU_CONTROL_REGISTER_BASE+0x00F0)
#define     CMU_DCPPLLDEBUG							(CMU_CONTROL_REGISTER_BASE+0x00F4)
...
#define     HDMI_TRANSMITTER_REGISTER_BASE          0xb02c0000
#define     HDMI_VICTL                              (HDMI_TRANSMITTER_REGISTER_BASE+0x0000)
#define     HDMI_VIVSYNC                            (HDMI_TRANSMITTER_REGISTER_BASE+0x0004)
#define     HDMI_VIVHSYNC                           (HDMI_TRANSMITTER_REGISTER_BASE+0x0008)
#define     HDMI_VIALSEOF                           (HDMI_TRANSMITTER_REGISTER_BASE+0x000C)
#define     HDMI_VIALSEEF                           (HDMI_TRANSMITTER_REGISTER_BASE+0x0010)
#define     HDMI_VIADLSE                            (HDMI_TRANSMITTER_REGISTER_BASE+0x0014)
#define     HDMI_AIFRAMEC                           (HDMI_TRANSMITTER_REGISTER_BASE+0x0020)
#define     HDMI_AICHSTABYTE0TO3                    (HDMI_TRANSMITTER_REGISTER_BASE+0x0024)
#define     HDMI_AICHSTABYTE4TO7                    (HDMI_TRANSMITTER_REGISTER_BASE+0x0028)
#define     HDMI_AICHSTABYTE8TO11                   (HDMI_TRANSMITTER_REGISTER_BASE+0x002C)
#define     HDMI_AICHSTABYTE12TO15                  (HDMI_TRANSMITTER_REGISTER_BASE+0x0030)
#define     HDMI_AICHSTABYTE16TO19                  (HDMI_TRANSMITTER_REGISTER_BASE+0x0034)
#define     HDMI_AICHSTABYTE20TO23                  (HDMI_TRANSMITTER_REGISTER_BASE+0x0038)
#define     HDMI_AICHSTASCN                         (HDMI_TRANSMITTER_REGISTER_BASE+0x003C)
#define     HDMI_VR                                 (HDMI_TRANSMITTER_REGISTER_BASE+0x0050)
#define     HDMI_CR                                 (HDMI_TRANSMITTER_REGISTER_BASE+0x0054)
#define     HDMI_SCHCR                              (HDMI_TRANSMITTER_REGISTER_BASE+0x0058)
#define     HDMI_ICR                                (HDMI_TRANSMITTER_REGISTER_BASE+0x005C)
#define     HDMI_SCR                                (HDMI_TRANSMITTER_REGISTER_BASE+0x0060)
#define     HDMI_LPCR                               (HDMI_TRANSMITTER_REGISTER_BASE+0x0064)
#define     HDCP_CR                                 (HDMI_TRANSMITTER_REGISTER_BASE+0x0068)
#define     HDCP_SR                                 (HDMI_TRANSMITTER_REGISTER_BASE+0x006C)
#define     HDCP_ANLR                               (HDMI_TRANSMITTER_REGISTER_BASE+0x0070)
#define     HDCP_ANMR                               (HDMI_TRANSMITTER_REGISTER_BASE+0x0074)
#define     HDCP_ANILR                              (HDMI_TRANSMITTER_REGISTER_BASE+0x0078)
#define     HDCP_ANIMR                              (HDMI_TRANSMITTER_REGISTER_BASE+0x007C)
#define     HDCP_DPKLR                              (HDMI_TRANSMITTER_REGISTER_BASE+0x0080)
#define     HDCP_DPKMR                              (HDMI_TRANSMITTER_REGISTER_BASE+0x0084)
#define     HDCP_LIR                                (HDMI_TRANSMITTER_REGISTER_BASE+0x0088)
#define     HDCP_SHACR                              (HDMI_TRANSMITTER_REGISTER_BASE+0x008C)
#define     HDCP_SHADR                              (HDMI_TRANSMITTER_REGISTER_BASE+0x0090)
#define     HDCP_ICR                                (HDMI_TRANSMITTER_REGISTER_BASE+0x0094)
#define     HDCP_KMMR                               (HDMI_TRANSMITTER_REGISTER_BASE+0x0098)
#define     HDCP_KMLR                               (HDMI_TRANSMITTER_REGISTER_BASE+0x009C)
#define     HDCP_MILR                               (HDMI_TRANSMITTER_REGISTER_BASE+0x00A0)
#define     HDCP_MIMR                               (HDMI_TRANSMITTER_REGISTER_BASE+0x00A4)
#define     HDCP_KOWR                               (HDMI_TRANSMITTER_REGISTER_BASE+0x00A8)
#define     HDCP_OWR                                (HDMI_TRANSMITTER_REGISTER_BASE+0x00AC)
#define     TMDS_STR0                               (HDMI_TRANSMITTER_REGISTER_BASE+0x00B8)
#define     TMDS_STR1                               (HDMI_TRANSMITTER_REGISTER_BASE+0x00BC)
#define     TMDS_EODR0                              (HDMI_TRANSMITTER_REGISTER_BASE+0x00C0)
#define     TMDS_EODR1                              (HDMI_TRANSMITTER_REGISTER_BASE+0x00C4)
#define     HDMI_ASPCR                              (HDMI_TRANSMITTER_REGISTER_BASE+0x00D0)
#define     HDMI_ACACR                              (HDMI_TRANSMITTER_REGISTER_BASE+0x00D4)
#define     HDMI_ACRPCR                             (HDMI_TRANSMITTER_REGISTER_BASE+0x00D8)
#define     HDMI_ACRPCTSR                           (HDMI_TRANSMITTER_REGISTER_BASE+0x00DC)
#define     HDMI_ACRPPR                             (HDMI_TRANSMITTER_REGISTER_BASE+0x00E0)
#define     HDMI_GCPCR                              (HDMI_TRANSMITTER_REGISTER_BASE+0x00E4)
#define     HDMI_RPCR                               (HDMI_TRANSMITTER_REGISTER_BASE+0x00E8)
#define     HDMI_RPRBDR                             (HDMI_TRANSMITTER_REGISTER_BASE+0x00EC)
#define     HDMI_OPCR                               (HDMI_TRANSMITTER_REGISTER_BASE+0x00F0)
#define     HDMI_DIPCCR                             (HDMI_TRANSMITTER_REGISTER_BASE+0x00F4)
#define     HDMI_ORP6PH                             (HDMI_TRANSMITTER_REGISTER_BASE+0x00F8)
#define     HDMI_ORSP6W0                            (HDMI_TRANSMITTER_REGISTER_BASE+0x00FC)
#define     HDMI_ORSP6W1                            (HDMI_TRANSMITTER_REGISTER_BASE+0x0100)
#define     HDMI_ORSP6W2                            (HDMI_TRANSMITTER_REGISTER_BASE+0x0104)
#define     HDMI_ORSP6W3                            (HDMI_TRANSMITTER_REGISTER_BASE+0x0108)
#define     HDMI_ORSP6W4                            (HDMI_TRANSMITTER_REGISTER_BASE+0x010C)
#define     HDMI_ORSP6W5                            (HDMI_TRANSMITTER_REGISTER_BASE+0x0110)
#define     HDMI_ORSP6W6                            (HDMI_TRANSMITTER_REGISTER_BASE+0x0114)
#define     HDMI_ORSP6W7                            (HDMI_TRANSMITTER_REGISTER_BASE+0x0118)
#define     HDMI_CECCR                              (HDMI_TRANSMITTER_REGISTER_BASE+0x011C)
#define     HDMI_CECRTCR                            (HDMI_TRANSMITTER_REGISTER_BASE+0x0120)
#define     HDMI_CECRXCR                            (HDMI_TRANSMITTER_REGISTER_BASE+0x0124)
#define     HDMI_CECTXCR                            (HDMI_TRANSMITTER_REGISTER_BASE+0x0128)
#define     HDMI_CECTXDR                            (HDMI_TRANSMITTER_REGISTER_BASE+0x012C)
#define     HDMI_CECRXDR                            (HDMI_TRANSMITTER_REGISTER_BASE+0x0130)
#define     HDMI_CECRXTCR                           (HDMI_TRANSMITTER_REGISTER_BASE+0x0134)
#define     HDMI_CECTXTCR0                          (HDMI_TRANSMITTER_REGISTER_BASE+0x0138)
#define     HDMI_CECTXTCR1                          (HDMI_TRANSMITTER_REGISTER_BASE+0x013C)
#define     HDMI_CRCCR                              (HDMI_TRANSMITTER_REGISTER_BASE+0x0140)
#define     HDMI_CRCDOR                             (HDMI_TRANSMITTER_REGISTER_BASE+0x0144)
#define     HDMI_TX_1                               (HDMI_TRANSMITTER_REGISTER_BASE+0x0154)
#define     HDMI_TX_2                               (HDMI_TRANSMITTER_REGISTER_BASE+0x0158)
#define     CEC_DDC_HPD                             (HDMI_TRANSMITTER_REGISTER_BASE+0x015C)
